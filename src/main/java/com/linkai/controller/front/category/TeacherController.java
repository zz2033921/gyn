...
/**
 * @author ：zdp
 * @date ：Created in 2020/12/28 15:38
 * @description：
 * @modified By：
 * @version: $
 */
@Controller
@RequestMapping("/category/teacher")
public class TeacherController extends BaseCategoryController{
    /**
     * 教师资格证首页
     */
    ...
    public ModelAndView juniorIndex(@RequestParam(value = "pageNum",required=false)Integer page){
        ...
        final PageInfo<IndexProductDto> pageInfo= super.getProductWithPage(page, 6, "create_time desc", "教师资格证");
        modelAndView.addObject("page",pageInfo);
        modelAndView.addObject("tag", CustomizeVariable.COWBOY_PLANT.getName());
        modelAndView.setViewName("/front/category/teacher");
        return modelAndView;
    }
}
