...
/**
 * @author ：zdp
 * @date ：Created in 2020/12/28 16:01
 * @description：
 * @modified By：
 * @version: $
 */
...
@Controller
@RequestMapping("/category/science")
public class ScienceController extends BaseCategoryController{
    /**
     * 科技首页
     */
    ...
    public ModelAndView juniorIndex(@RequestParam(value = "pageNum",required=false)Integer page){
        ...
        final PageInfo<IndexProductDto> pageInfo= super.getProductWithPage(page, 6, "create_time desc", "科技");
        modelAndView.addObject("page",pageInfo);
        modelAndView.addObject("tag", CustomizeVariable.COWBOY_PLANT.getName());
        modelAndView.setViewName("/front/category/science");
        return modelAndView;
    }
}
