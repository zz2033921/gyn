...
/**
 * @author ：zdp
 * @date ：Created in 2020/12/28 15:39
 * @description：
 * @modified By：
 * @version: $
 */
...
@Controller
@RequestMapping("/category/staff")
public class StaffController extends BaseCategoryController{
    /**
     * 公务员首页
     */
    ...
    public ModelAndView juniorIndex(@RequestParam(value = "pageNum",required=false)Integer page){
        ...
        final PageInfo<IndexProductDto> pageInfo= super.getProductWithPage(page, 6, "create_time desc", "公务员");
        modelAndView.addObject("page",pageInfo);
        modelAndView.addObject("tag", CustomizeVariable.COWBOY_PLANT.getName());
        modelAndView.setViewName("/front/category/staff");
        return modelAndView;
    }
}
