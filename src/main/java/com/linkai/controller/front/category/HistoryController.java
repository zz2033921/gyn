...
public class HistoryController extends BaseCategoryController{
    /**
     * 历史首页
     */
    ...
    public ModelAndView juniorIndex(@RequestParam(value = "pageNum",required=false)Integer page){
        ...
        final PageInfo<IndexProductDto> pageInfo= super.getProductWithPage(page, 6, "create_time desc", "历史");
        modelAndView.addObject("page",pageInfo);
        modelAndView.addObject("tag", CustomizeVariable.COWBOY_PLANT.getName());
        modelAndView.setViewName("/front/category/history");
        return modelAndView;
    }
}
