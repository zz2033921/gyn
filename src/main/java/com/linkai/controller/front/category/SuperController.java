...
@Controller
@RequestMapping("/category/super")
public class SuperController extends BaseCategoryController{
    /**
     * 大中专教辅首页
     */
    ...
    public ModelAndView juniorIndex(@RequestParam(value = "pageNum",required=false)Integer page){
        ...
        final PageInfo<IndexProductDto> pageInfo= super.getProductWithPage(page, 6, "create_time desc", "大中专教辅");
        modelAndView.addObject("page",pageInfo);
        modelAndView.addObject("tag", CustomizeVariable.COWBOY_PLANT.getName());
        modelAndView.setViewName("/front/category/super");
        return modelAndView;
    }
}
