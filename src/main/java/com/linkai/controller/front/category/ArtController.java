...
@Controller
@RequestMapping("/category/art")
public class ArtController extends BaseCategoryController{
    /**
     * 艺术首页
     */
    ...
    public ModelAndView juniorIndex(@RequestParam(value = "pageNum",required=false)Integer page){
        ...
        final PageInfo<IndexProductDto> pageInfo= super.getProductWithPage(page, 6, "create_time desc", "艺术");
        modelAndView.addObject("page",pageInfo);
        modelAndView.addObject("tag", CustomizeVariable.COWBOY_PLANT.getName());
        modelAndView.setViewName("/front/category/art");
        return modelAndView;
    }
}
