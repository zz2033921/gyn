jQuery(function () {
    function e(e) {
        ...
        "invalid" === e.getStatus() ? d(e.statusText) : (t.text("预览中"), n.makeThumb(e, function (e, a) {
            ...
            if (num<2){
                //TODO：设置按钮不可按
                $(".uploadBtn").addClass('noClick');
                toastr.error('商品图片至少为两张！','提示：')
                return ;
            }else {
                $(".uploadBtn").removeClass('noClick');
            }
    ...
    var n, o = jQuery, r = o("#uploader"), l = o('<ul class="filelist"></ul>').appendTo(r.find(".queueList")),
        ...
        f = d.find(".progress").hide(), m = 0,num=0, h = 0, g = window.devicePixelRatio || 1, v = 110 * g, b = 110 * g,
    ...
    n = WebUploader.create({
        ...
        m++,num++, h += a.size, 1 === m && (u.addClass("element-invisible"), d.show()), e(a), t("ready"), s()
