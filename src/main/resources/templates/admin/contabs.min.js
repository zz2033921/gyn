$(function () {
    ...
    function n() {
        var t = $(this).attr("href"), ico=$(this).attr('data-ico'), dcode=$(this).attr('data-code'), a = $(this).data("index"), i = $.trim($(this).text()), n = !0;
        ...
        if ($(".J_menuTab").each(function () {
            ...
            var s = '<a href="javascript:;" class="active J_menuTab" data-id="' + t + '"> <span class="'+ico+'"> </span> ' + i + ' <i class="fa fa-times-circle"></i></a>';
            $(".J_menuTab").removeClass("active");
            var r = '<iframe class="J_iframe" name="iframe' + a + '" data-code="'+dcode+'" width="100%" height="100%" src="' + t + '?v=4.0" frameborder="0" data-id="' + t + '" seamless></iframe>';
